...
export function TokenInfoProvider({ children }) {
    ...
    async function fetchData() {
        try {
            ...
            axios.get(
                `https://api.etherscan.io/api?module=account&action=tokentx&address=${BUYBACK_ADDR}&contractaddress=${WPT_ADDR}&page=1&offset=1000&sort=desc&apikey=47I5RB52NG9GZ95TEA38EXNKCAT4DMV5RX`
            ).then(result => {
    ...
    async function fetchBalance() {
        try {
            ...
            setBalance(result);
            let txlist = await axios.get(`https://api.etherscan.io/api?module=account&action=tokentx&address=${account}&contractaddress=${WPT_ADDR}&page=1&offset=1000&sort=desc&apikey=47I5RB52NG9GZ95TEA38EXNKCAT4DMV5RX`);
